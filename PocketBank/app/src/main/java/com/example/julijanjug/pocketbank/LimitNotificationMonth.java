...
public class LimitNotificationMonth extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        bigText.bigText("You are reaching your balance limit for this month");
        bigText.setBigContentTitle("Nearing monthly limit!");
